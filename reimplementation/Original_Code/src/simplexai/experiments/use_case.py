...
def mnist_use_case(
    random_seed=42,
    save_path: str = "iml/simplex/src/simplexai/experiments/experiments/results/mnist/use_case/",  #"experiments/results/mnist/use_case/",
    ...
    # Prepare data
    train_loader = load_mnist(batch_size_train, train=True, shuffle=False)
    test_loader = load_mnist(batch_size_test, train=False, shuffle=False)
    ...
    test_inputs = test_inputs[test_id : test_id + 1].to(device).detach()    #pick one example
